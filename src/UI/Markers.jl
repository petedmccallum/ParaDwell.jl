...
name="before 1919";     addmarkers(project; name=name, filt=Dict("column"=>:ParaDwell_Age_Band,"value"=>name),  colour = "#1B1464",   size = 7)
name="1919-1929";       addmarkers(project; name=name, filt=Dict("column"=>:ParaDwell_Age_Band,"value"=>name),  colour = "#9980FA",   size = 7)
name="1930-1949";       addmarkers(project; name=name, filt=Dict("column"=>:ParaDwell_Age_Band,"value"=>name),  colour = "#C4E538",   size = 7)
name="1950-1964";       addmarkers(project; name=name, filt=Dict("column"=>:ParaDwell_Age_Band,"value"=>name),  colour = "#EE5A24",   size = 7)
name="1965-1975";       addmarkers(project; name=name, filt=Dict("column"=>:ParaDwell_Age_Band,"value"=>name),  colour = "#e1b12c",   size = 7)
name="1976-1983";       addmarkers(project; name=name, filt=Dict("column"=>:ParaDwell_Age_Band,"value"=>name),  colour = "#f78fb3",   size = 7)
name="1984-1991";       addmarkers(project; name=name, filt=Dict("column"=>:ParaDwell_Age_Band,"value"=>name),  colour = "#3dc1d3",   size = 7)
name="1992-1998";       addmarkers(project; name=name, filt=Dict("column"=>:ParaDwell_Age_Band,"value"=>name),  colour = "#5758BB",   size = 7)
name="1999-2002";       addmarkers(project; name=name, filt=Dict("column"=>:ParaDwell_Age_Band,"value"=>name),  colour = "#f19066",   size = 7)
name="2003-2007";       addmarkers(project; name=name, filt=Dict("column"=>:ParaDwell_Age_Band,"value"=>name),  colour = "#c44569",   size = 7)
name="2008 onwards";    addmarkers(project; name=name, filt=Dict("column"=>:ParaDwell_Age_Band,"value"=>name),  colour = "#fed330",   size = 7)
